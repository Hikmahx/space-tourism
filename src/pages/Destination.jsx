...
const Destination = () => {
  ...
  return (
    ...
    <div className="destination-wrapper lg:overflow-hidden">
      ...
      <div className="tabs relative mt-20 pt-2 pb-16 sm:pb-14 sm:mt-32 lg:mt-20  font-barlow text-white max-w-xs sm:max-w-2xl lg:max-w-none mx-auto lg:flex lg:items-center lg:justify-center xl:justify-between">
        <div className="container flex flex-col lg:flex-row text-center lg:text-left items-center justify-center mx-auto">
          <div className="tab-left w-4/5 sm:w-full xl:w-1/2">
            <h1 className="uppercase text-base tracking-widest sm:text-2xl sm:text-left"><strong className="mr-4 text-grayish-blue">01</strong>pick your destination</h1>

            <div className="img-wrapper w-full">
              <img className="w-full py-7 px-11 sm:pt-12 sm:px-44 sm:pb-12" src={`${destinations[0].images.png.slice(1)}`} alt="tab-img" />
            </div>
          ...
          <div className="tab-body">
            <h2 className="uppercase font-belleFair text-6xl sm:text-7xl sm:mt-10 py-1">{destinations[0].name}</h2>
            <p className="text-light-blue leading-6 mb-9 sm:mt-4 sm:text-lg sm:mb-11">{destinations[0].description}</p>
            <div className="line my-6 bg-white w-full"></div>
            <div className="tab-info mt-8 sm:flex sm:items-center sm:justify-around">
