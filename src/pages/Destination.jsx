...
const Destination = () => {
  ...
  return (
    ...
    <div className="destination-wrapper lg:overflow-hidden">
      ...
      <div className="tabs relative mt-20 pt-2 pb-16 sm:mt-32 lg:mt-20  font-barlow text-white max-w-xs sm:max-w-2xl lg:max-w-none mx-auto lg:flex lg:items-center lg:justify-center xl:justify-between">
