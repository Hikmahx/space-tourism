  ...
  return (
    <div>
      <div className="crew-wrapper xl:min-h-screen lg:overflow-hidden">
        ...
        <div className="relative slider mt-20 pb-28 md:pb-0 pt-1 font-barlow text-white xl:px-20">
          <h1 className="uppercase mb-10 text-base sm:text-2xl text-center sm:text-left sm:px-10 sm:pt-8"><strong className="mr-4 text-grayish-blue xl:font-bold">02</strong>meet your crew</h1>
          <div className="container flex flex-col xl:flex-row text-center xl:text-left items-center justify-center mx-auto">
            ...
            <div className="slider-right md:order-2 w-4/5 xl:w-1/2">
              <div className="slider-img-wrapper px-16 max-w-xl mx-auto">
                <img className="px-2 sm:px-5" src={`${crew[0].images.png.slice(1)}`} alt="slider-img"/>         
              </div>
            ...
            <div className="slider-left md:order-1 w-4/5 xl:w-1/2 flex flex-col">
              <div className="slider-info order-2 md:order-1">
                <h2 className="uppercase font-belleFair text-2xl sm:text-4xl sm:mt-6 py-1 xl:mb-6">
                  <span style={{color:'#61636a'}} className="block text-base sm:text-2xl mb-1 sm:mb-3">
                    {crew[0].role}
                  </span>
                ...
                <p className="text-light-blue text-base sm:text-lg max-w-lg mx-auto">
                  {crew[0].bio}
                </p>
              </div>
              <div className="manual-navigation order-1 md:order-2 w-full h-auto flex items-center justify-center lg:justify-start mt-6 sm:mt-7 mb-4">
